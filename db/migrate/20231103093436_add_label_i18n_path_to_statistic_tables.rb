...
class AddLabelI18nPathToStatisticTables < ActiveRecord::Migration[5.2] # Commit changed from [7.0] to [5.2]
  def change
    ...
    if StatisticField.count > 0
      ...
      record = StatisticField.find_by(key: 'groupName', statistic_index_id: statistic_index_subscription&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.group')

      record = StatisticField.find_by(key: 'spaceDates', statistic_index_id: statistic_index_space&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.space_dates')
      record = StatisticField.find_by(key: 'groupName', statistic_index_id: statistic_index_space&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.group')

      record = StatisticField.find_by(key: 'machineDates', statistic_index_id: statistic_index_machine&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.machine_dates')
      record = StatisticField.find_by(key: 'groupName', statistic_index_id: statistic_index_machine&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.group')

      record = StatisticField.find_by(key: 'trainingId', statistic_index_id: statistic_index_training&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.training_id')
      record = StatisticField.find_by(key: 'trainingDate', statistic_index_id: statistic_index_training&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.training_date')
      record = StatisticField.find_by(key: 'groupName', statistic_index_id: statistic_index_training&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.group')

      record = StatisticField.find_by(key: 'name', statistic_index_id: statistic_index_event&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.event_name')
      record = StatisticField.find_by(key: 'eventId', statistic_index_id: statistic_index_event&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.event_id')
      record = StatisticField.find_by(key: 'eventDate', statistic_index_id: statistic_index_event&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.event_date')
      record = StatisticField.find_by(key: 'groupName', statistic_index_id: statistic_index_event&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.group')
      record = StatisticField.find_by(key: 'eventTheme', statistic_index_id: statistic_index_event&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.event_theme')
      record = StatisticField.find_by(key: 'ageRange', statistic_index_id: statistic_index_event&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.age_range')

      record = StatisticField.find_by(key: 'groupName', statistic_index_id: statistic_index_account&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.group')

      record = StatisticField.find_by(key: 'themes', statistic_index_id: statistic_index_project&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.themes')
      record = StatisticField.find_by(key: 'components', statistic_index_id: statistic_index_project&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.components')
      record = StatisticField.find_by(key: 'machines', statistic_index_id: statistic_index_project&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.machines')
      record = StatisticField.find_by(key: 'status', statistic_index_id: statistic_index_project&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.project_status')
      record = StatisticField.find_by(key: 'name', statistic_index_id: statistic_index_project&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.project_name')
      record = StatisticField.find_by(key: 'projectUserNames', statistic_index_id: statistic_index_project&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.project_user_names')

      record = StatisticField.find_by(key: 'userId', statistic_index_id: statistic_index_user&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.user_id')

      record = StatisticField.find_by(key: 'groupName', statistic_index_id: statistic_index_order&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.group')
    end

    # StatisticType
    if StatisticType.count > 0
      record = StatisticType.find_by(key: 'booking', statistic_index_id: statistic_index_machine&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.bookings')
      record = StatisticType.find_by(key: 'hour', statistic_index_id: statistic_index_machine&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.hours_number')

      record = StatisticType.find_by(key: 'booking', statistic_index_id: statistic_index_training&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.bookings')
      record = StatisticType.find_by(key: 'hour', statistic_index_id: statistic_index_training&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.hours_number')

      record = StatisticType.find_by(key: 'booking', statistic_index_id: statistic_index_event&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.tickets_number')
      record = StatisticType.find_by(key: 'hour', statistic_index_id: statistic_index_event&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.hours_number')

      record = StatisticType.find_by(key: 'member', statistic_index_id: statistic_index_account&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.users')

      record = StatisticType.find_by(key: 'project', statistic_index_id: statistic_index_project&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.projects')

      record = StatisticType.find_by(key: 'revenue', statistic_index_id: statistic_index_user&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.revenue')

      record = StatisticType.find_by(key: 'booking', statistic_index_id: statistic_index_space&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.bookings')
      record = StatisticType.find_by(key: 'hour', statistic_index_id: statistic_index_space&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.hours_number')

      record = StatisticType.find_by(key: 'store', statistic_index_id: statistic_index_order&.id)
      record&.update(label: nil, label_i18n_path: 'statistics.store')
    ...
    if StatisticSubType.count > 0
      record = StatisticSubType.find_by(key: 'created')
      record&.update(label: nil, label_i18n_path: 'statistics.account_creation')
      record = StatisticSubType.find_by(key: 'published')
      record&.update(label: nil, label_i18n_path: 'statistics.project_publication')
      record = StatisticSubType.find_by(key: 'paid-processed')
      record&.update(label: nil, label_i18n_path: 'statistics.paid-rocessed')
      record = StatisticSubType.find_by(key: 'aborted')
      record&.update(label: nil, label_i18n_path: 'statistics.aborted')
