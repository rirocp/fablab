      ...
      <div className="group">
        ...
        {cart && !cartIsEmpty() &&
          <div className="store-cart-info">
            ...
            <ul>
              <li><strong>Confirmation du prêt</strong> : Une fois votre commande passée et votre prêt validé lors du rendez-vous, vous recevrez un email de confirmation pour vous assurer que tout est en ordre.</li>
              <li><strong>Rappel avant la fin du délai</strong> : Une semaine avant l’écoulement du délai de prêt, nous vous enverrons un email pour vous rappeler de retourner l’article.</li>
              <li><strong>Notification en cas d’annulation</strong> : Si votre prêt est annulé pour une raison quelconque, vous serez immédiatement informé par email.</li>
            </ul>
          </div>
          }
